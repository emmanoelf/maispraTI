...
import dataStructure.lists.DoublyLinkedList;

import java.util.Scanner;

public class Main {
    public static void main(String[] args) {
        DoublyLinkedList<ReundoEditor> editorVersion = new DoublyLinkedList<>();
            ...
            while(true){
                ...
                switch (option){
                    case "1":
                        ...
                        editorVersion.insertLast(new ReundoEditor(text));
                        break;
                    case "2":
    ...
    private static String getFullText(DoublyLinkedList<ReundoEditor> editorVersion){
    ...
    private static String getSpecificVersion(DoublyLinkedList<ReundoEditor> editorVersion, int version){
        StringBuilder sb = new StringBuilder();
        int count = 0;
